  ...
  if (step === 'vision') {
    const slides: Array<{
      ...
      },
      {
        ...
        desc: 'Offline maps, GPS tracking and real-time weather — even out of reach.',
        descFr: 'Cartes offline, tracking GPS et météo live — même hors réseau.',
        bullets: [
          ...
          { icon: '🌦️', fr: 'Météo et conditions live communauté', en: 'Live weather + community conditions' },
        ],
