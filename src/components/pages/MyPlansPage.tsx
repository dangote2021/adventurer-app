      ...
      <div className="px-4 py-4 space-y-3">
        {savedPlans.length === 0 && (
          <div className="text-center py-16 px-4 text-gray-400">
            ...
            <p className="text-sm font-medium text-white mb-2">{t('plan.noPlans', language)}</p>
            <p className="text-xs text-gray-400 mb-5 max-w-xs mx-auto leading-relaxed">{t('plan.noPlansHint', language)}</p>
            <button
              type="button"
