...
export const MAP_SPOTS: SpotItem[] = [
  ...
  },
  {
    id: 5,
    emoji: '🪁',
    // S11 panel V6 (Yannick) — Los Lances = école/débutants, sandbar.
    // Le vrai spot kite expert de Tarifa c'est Valdevaqueros (déjà présent ligne 1727).
    ...
    lng: -5.60,
    sport: 'Kitesurf',
    description: 'Sandbar accessible débutants/intermédiaires. Eau peu profonde, école principale du coin.',
    windSpeed: 22,
    windDirection: 'E',
    windStatus: 'Levante 22 nds',
    waterType: 'mixed',
    windQuality: 'gusty',
    bestWind: ['E', 'W'],
  ...
  },
  {
    ...
    lng: -1.44,
    sport: 'Surf',
    description: 'Beach break puissant. Marées fortes, fonctionne mieux à mi-marée montante.',
    windSpeed: 12,
    windDirection: 'NO',
  ...
  },
  {
    ...
    lng: 6.22,
    sport: 'Plongée',
    description: 'Épave mythique, 50m. Plongée tek encadrée — niveau N3/Tek.'
  },
  {
    id: 8,
    emoji: '🪂',
  ...
  },
  {
    ...
    lng: -15.95,
    sport: 'Kitesurf',
    // S11 panel V6 (Yannick) — Lassarga = vraie config Dakhla : NNE/N franc
    // (pas NE), et la VRAIE info qui choisit le spot c'est lagune flat / océan vague.
    description: 'Spot consistency au choix : lagune flat (kite freestyle) ou océan vague (strapless). Vent thermique régulier.',
    windSpeed: 18,
    windDirection: 'NNE',
    windStatus: 'Alizés thermiques 18 nds',
    waterType: 'flat-lagoon',
    windQuality: 'thermique',
    bestWind: ['N', 'NE'],
    tideDependence: false,
  },
  {
  ...
  // S14 panel V6 (Yannick) — spots monde manquants
  {
    id: 21,
    emoji: '🪁',
    name: 'Lac de Garde — Malcesine',
    type: 'Spot kite/wing',
    rating: 4.8,
    lat: 45.76,
    lng: 10.81,
    sport: 'Kitesurf',
    description: 'Pelér le matin au sud (Torbole), Ora l\'après-midi au nord (Malcesine). Plan d\'eau alpin.',
    windSpeed: 18,
    windDirection: 'N',
    windStatus: 'Pelér matinal',
    waterType: 'choppy',
    windQuality: 'thermique',
    bestWind: ['N', 'S'],
    tideDependence: false,
  },
  {
    id: 22,
    emoji: '🪁',
    name: 'Cap-Vert — Sal (Punta Preta)',
    type: 'Spot kite',
    rating: 4.9,
    lat: 16.59,
    lng: -22.94,
    sport: 'Kitesurf',
    description: 'Alizés réguliers nov-juin, océan vague + flat selon orientation. Spot de progression strapless.',
    windSpeed: 22,
    windDirection: 'NE',
    windStatus: 'Alizés 22 nds',
    waterType: 'wave',
    windQuality: 'stable',
    bestWind: ['NE', 'E'],
    tideDependence: true,
  },
  {
    id: 23,
    emoji: '🪁',
    name: 'Île Maurice — Le Morne',
    type: 'Spot kite/wave',
    rating: 4.9,
    lat: -20.46,
    lng: 57.31,
    sport: 'Kitesurf',
    description: 'Lagon flat à One Eye + vague iconique en récif extérieur. Alizés austraux, eau 24°C.',
    windSpeed: 20,
    windDirection: 'SE',
    windStatus: 'Alizés réguliers',
    waterType: 'mixed',
    windQuality: 'stable',
    bestWind: ['SE', 'E'],
    tideDependence: true,
  },
  {
    id: 24,
    emoji: '🪁',
    name: 'Maroc — Essaouira',
    type: 'Spot kite/windsurf',
    rating: 4.6,
    lat: 31.51,
    lng: -9.77,
    sport: 'Kitesurf',
    description: 'Vent thermique nord puissant l\'après-midi, baie protégée. Idéal débutants/intermédiaires été.',
    windSpeed: 22,
    windDirection: 'N',
    windStatus: 'Thermique soutenu',
    waterType: 'choppy',
    windQuality: 'thermique',
    bestWind: ['N', 'NE'],
    tideDependence: true,
  },
  {
    ...
    type: 'Spot windsurf/kite',
    rating: 4.7,
    lat: 45.71,
    lng: -121.52,
    sport: 'Windsurf',
    description: 'Spot iconique du Pacific Northwest. Vent gorge thermique régulier en été. Eau 18°C.',
    windSpeed: 25,
    windDirection: 'W',
    windStatus: 'Gorge wind',
    waterType: 'choppy',
    windQuality: 'thermique',
    bestWind: ['W'],
    tideDependence: false,
